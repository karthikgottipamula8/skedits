...
const DEFAULT_ITEMS = [
  { image: 'https://picsum.photos/seed/depth1/800/1000', alt: 'Coach Reel 1', title: 'Monarch High-Retention Edit' },
  { image: 'https://picsum.photos/seed/depth2/800/1000', alt: 'Coach Reel 2', title: 'Client Acquisition Hook' },
  { image: 'https://picsum.photos/seed/depth3/800/1000', alt: 'Coach Reel 3', title: 'Viral Coaching Reel' },
  { image: 'https://picsum.photos/seed/depth4/800/1000', alt: 'Coach Reel 4', title: 'Masterclass Launch Promo' },
  { image: 'https://picsum.photos/seed/depth5/800/1000', alt: 'Coach Reel 5', title: 'Diet & Fitness Breakdown' }
];
    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          <div
            key={i}
            className={`depth-carousel__card ${active === i ? 'is-focused' : ''}`}
          ...
          >
            ...
            {item.badge && (
              <span className="depth-carousel__badge">{item.badge}</span>
            )}
            {item.duration && (
              <span className="depth-carousel__duration">{item.duration}</span>
            )}
            <div className="depth-carousel__play-btn">
